...
<title>~the_friar/macintosh-cookbook: examples/file.bin.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Ffile.bin.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/file.bin.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.bin.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.bin.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/file.bin.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/file.bin.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.bin.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleFileBinary</span><span class="o">;</span>
 ...
 <span class="k">type</span>
  <span class="n">Number_File</span> <span class="o">=</span> <span class="k">file</span> <span class="k">of</span> <span class="kt">real</span><span class="o">;</span>

 <span class="k">var</span>
  <span class="n">Data_Block</span><span class="o">:</span> <span class="n">Number_File</span><span class="o">;</span>
  <span class="n">Counter</span><span class="o">:</span> <span class="kt">integer</span><span class="o">;</span>
  <span class="n">A</span><span class="o">:</span> <span class="k">array</span><span class="p">[</span><span class="mi">1</span><span class="o">..</span><span class="mi">10</span><span class="p">]</span> <span class="k">of</span> <span class="kt">real</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="k">for</span> <span class="n">Counter</span> <span class="o">:=</span> <span class="mi">1</span> <span class="k">to</span> <span class="mi">10</span> <span class="k">do</span>
  <span class="n">A</span><span class="p">[</span><span class="n">Counter</span><span class="p">]</span> <span class="o">:=</span> <span class="nb">random</span><span class="o">;</span>

 <span class="n">Open</span><span class="p">(</span><span class="n">Data_Block</span><span class="o">,</span> <span class="s">'data'</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Rewrite</span><span class="p">(</span><span class="n">Data_Block</span><span class="p">)</span><span class="o">;</span>

 <span class="k">for</span> <span class="n">Counter</span> <span class="o">:=</span> <span class="mi">1</span> <span class="k">to</span> <span class="mi">10</span> <span class="k">do</span>
  <span class="nb">Write</span><span class="p">(</span><span class="n">Data_Block</span><span class="o">,</span> <span class="n">A</span><span class="p">[</span><span class="n">Counter</span><span class="p">])</span><span class="o">;</span>

 <span class="nb">Close</span><span class="p">(</span><span class="n">Data_Block</span><span class="p">)</span><span class="o">;</span>
