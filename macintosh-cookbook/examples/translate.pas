...
<title>~the_friar/macintosh-cookbook: examples/translate.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Ftranslate.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/translate.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/translate.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/translate.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/translate.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/translate.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/translate.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleTranslate</span><span class="o">;</span>

 <span class="k">var</span>
  <span class="n">clip</span><span class="o">:</span> <span class="nb">Rect</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="n">ShowDrawing</span><span class="o">;</span>

<span class="cm">{ origine }</span>
 <span class="n">SetRect</span><span class="p">(</span><span class="n">clip</span><span class="o">,</span> <span class="mi">10</span><span class="o">,</span> <span class="mi">10</span><span class="o">,</span> <span class="mi">100</span><span class="o">,</span> <span class="mi">100</span><span class="p">)</span><span class="o">;</span>
 <span class="n">PaintArc</span><span class="p">(</span><span class="n">clip</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="mi">180</span><span class="p">)</span><span class="o">;</span>
 <span class="n">FrameRect</span><span class="p">(</span><span class="n">clip</span><span class="p">)</span><span class="o">;</span>

<span class="cm">{ translation }</span>
 <span class="n">EraseArc</span><span class="p">(</span><span class="n">clip</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="mi">180</span><span class="p">)</span><span class="o">;</span>
 <span class="n">OffSetRect</span><span class="p">(</span><span class="n">clip</span><span class="o">,</span> <span class="mi">40</span><span class="o">,</span> <span class="mi">40</span><span class="p">)</span><span class="o">;</span>
 <span class="n">PaintArc</span><span class="p">(</span><span class="n">clip</span><span class="o">,</span> <span class="mi">0</span><span class="o">,</span> <span class="mi">180</span><span class="p">)</span><span class="o">;</span>
 <span class="n">FrameRect</span><span class="p">(</span><span class="n">clip</span><span class="p">)</span><span class="o">;</span>
