...
<title>~the_friar/macintosh-cookbook: examples/bitwise.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Fbitwise.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/bitwise.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/bitwise.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/bitwise.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/bitwise.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/bitwise.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/bitwise.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<a href="#L21" id="L21">21</a></pre>
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleBitwise</span><span class="o">;</span>

 <span class="k">var</span>
  <span class="n">value</span><span class="o">,</span> <span class="n">mask</span><span class="o">:</span> <span class="kt">Integer</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="n">ShowText</span><span class="o">;</span>

 <span class="nb">Writeln</span><span class="p">(</span><span class="n">BAnd</span><span class="p">(</span><span class="mi">20</span><span class="o">,</span> <span class="mi">123</span><span class="p">))</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">Btst</span><span class="p">(</span><span class="mi">20</span><span class="o">,</span> <span class="mi">16</span><span class="p">))</span><span class="o">;</span>

<span class="cm">{ compare }</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">Bxor</span><span class="p">(</span><span class="mi">20</span><span class="o">,</span> <span class="mi">123</span><span class="p">))</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">Bor</span><span class="p">(</span><span class="mi">20</span><span class="o">,</span> <span class="mi">123</span><span class="p">))</span><span class="o">;</span>

<span class="cm">{bit shift }</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">Bsl</span><span class="p">(</span><span class="mi">20</span><span class="o">,</span> <span class="mi">1</span><span class="p">))</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">Bsr</span><span class="p">(</span><span class="mi">20</span><span class="o">,</span> <span class="mi">1</span><span class="p">))</span><span class="o">;</span>
