...
<title>~the_friar/macintosh-cookbook: examples/file.read.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Ffile.read.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/file.read.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.read.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.read.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/file.read.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/file.read.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.read.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleFileRead</span><span class="o">;</span>

 <span class="k">procedure</span> <span class="nf">ReadFile</span><span class="o">;</span>
  <span class="k">var</span>
   <span class="n">i</span><span class="o">:</span> <span class="kt">Integer</span><span class="o">;</span>
   <span class="n">data</span><span class="o">:</span> <span class="k">string</span><span class="o">;</span>
   <span class="n">infile</span><span class="o">:</span> <span class="n">Text</span><span class="o">;</span>
 <span class="k">begin</span>
  <span class="n">i</span> <span class="o">:=</span> <span class="mi">0</span><span class="o">;</span>
  <span class="n">Open</span><span class="p">(</span><span class="n">infile</span><span class="o">,</span> <span class="n">OldFileName</span><span class="p">(</span><span class="s">'Open txt file?'</span><span class="p">))</span><span class="o">;</span>
  <span class="k">repeat</span>
   <span class="n">i</span> <span class="o">:=</span> <span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span>
   <span class="nb">Readln</span><span class="p">(</span><span class="n">infile</span><span class="o">,</span> <span class="n">data</span><span class="p">)</span><span class="o">;</span>
   <span class="nb">Writeln</span><span class="p">(</span><span class="n">data</span><span class="p">)</span><span class="o">;</span>
  <span class="k">until</span> <span class="nb">eof</span><span class="p">(</span><span class="n">infile</span><span class="p">)</span><span class="o">;</span>
  <span class="nb">Reset</span><span class="p">(</span><span class="n">infile</span><span class="p">)</span><span class="o">;</span>
