...
<title>~the_friar/macintosh-cookbook: examples/euler.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Feuler.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/euler.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/euler.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/euler.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/euler.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/euler.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/euler.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">EulerSpiral</span><span class="o">;</span>

 <span class="k">const</span>
  <span class="n">l</span> <span class="o">=</span> <span class="mi">4</span><span class="o">;</span>
  <span class="n">a</span> <span class="o">=</span> <span class="mi">11</span><span class="o">;</span>
 <span class="k">var</span>
  <span class="n">wx</span><span class="o">,</span> <span class="n">wy</span><span class="o">,</span> <span class="n">wa</span><span class="o">:</span> <span class="kt">Real</span><span class="o">;</span>
  <span class="n">i</span><span class="o">:</span> <span class="kt">Integer</span><span class="o">;</span>
 <span class="k">procedure</span> <span class="nf">DrawAngle</span><span class="o">;</span>
  <span class="k">var</span>
   <span class="n">t</span><span class="o">:</span> <span class="kt">Real</span><span class="o">;</span>
 <span class="k">begin</span>
  <span class="n">MoveTo</span><span class="p">(</span><span class="nb">round</span><span class="p">(</span><span class="n">wx</span><span class="p">)</span><span class="o">,</span> <span class="nb">round</span><span class="p">(</span><span class="n">wy</span><span class="p">))</span><span class="o">;</span>
  <span class="n">t</span> <span class="o">:=</span> <span class="n">wa</span> <span class="o">*</span> <span class="nb">PI</span> <span class="o">/</span> <span class="mi">180</span><span class="o">;</span>
  <span class="n">wx</span> <span class="o">:=</span> <span class="n">wx</span> <span class="o">+</span> <span class="n">l</span> <span class="o">*</span> <span class="nb">cos</span><span class="p">(</span><span class="n">t</span><span class="p">)</span><span class="o">;</span>
  <span class="n">wy</span> <span class="o">:=</span> <span class="n">wy</span> <span class="o">+</span> <span class="n">l</span> <span class="o">*</span> <span class="nb">sin</span><span class="p">(</span><span class="n">t</span><span class="p">)</span><span class="o">;</span>
  <span class="n">wa</span> <span class="o">:=</span> <span class="n">wa</span> <span class="o">+</span> <span class="p">(</span><span class="n">i</span> <span class="o">*</span> <span class="n">a</span><span class="p">)</span><span class="o">;</span>
  <span class="n">LineTo</span><span class="p">(</span><span class="nb">round</span><span class="p">(</span><span class="n">wx</span><span class="p">)</span><span class="o">,</span> <span class="nb">round</span><span class="p">(</span><span class="n">wy</span><span class="p">))</span><span class="o">;</span>
 <span class="k">end</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="n">wx</span> <span class="o">:=</span> <span class="mi">100</span><span class="o">;</span>
 <span class="n">wy</span> <span class="o">:=</span> <span class="mi">300</span><span class="o">;</span>
 ...
 <span class="k">repeat</span>
  <span class="n">DrawAngle</span><span class="o">;</span>
  <span class="n">i</span> <span class="o">:=</span> <span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="o">;</span>
 <span class="k">until</span> <span class="n">i</span> <span class="o">&gt;</span> <span class="mi">20000</span><span class="o">;</span>
