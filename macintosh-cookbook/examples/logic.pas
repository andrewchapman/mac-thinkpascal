...
<title>~the_friar/macintosh-cookbook: examples/logic.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Flogic.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/logic.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/logic.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/logic.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/logic.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/logic.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/logic.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleLogic</span><span class="o">;</span>
...
<span class="k">begin</span>
 ...
 <span class="n">name</span> <span class="o">:=</span> <span class="s">'alice'</span><span class="o">;</span>
 <span class="k">if</span> <span class="p">(</span><span class="n">name</span> <span class="o">=</span> <span class="s">'alice'</span><span class="p">)</span> <span class="k">then</span>
  <span class="nb">Writeln</span><span class="p">(</span><span class="s">'The name is alice.'</span><span class="p">)</span>
 <span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="n">name</span> <span class="o">=</span> <span class="s">'bob'</span><span class="p">)</span> <span class="k">then</span>
  <span class="nb">Writeln</span><span class="p">(</span><span class="s">'The name is bob.'</span><span class="p">)</span>
 <span class="k">else</span>
  <span class="nb">Writeln</span><span class="p">(</span><span class="s">'The name is not alice nor bob.'</span><span class="p">)</span><span class="o">;</span>
