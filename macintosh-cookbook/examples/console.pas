...
<title>~the_friar/macintosh-cookbook: examples/console.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Fconsole.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/console.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/console.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/console.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/console.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/console.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/console.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleConsole</span><span class="o">;</span>

 <span class="k">const</span>
  <span class="n">message</span> <span class="o">=</span> <span class="s">' Welcome to the world of Pascal '</span><span class="o">;</span>

 <span class="k">type</span>
  <span class="n">name</span> <span class="o">=</span> <span class="k">String</span><span class="o">;</span>

 <span class="k">var</span>
  <span class="n">firstname</span><span class="o">,</span> <span class="n">surname</span><span class="o">:</span> <span class="n">name</span><span class="o">;</span>

<span class="k">begin</span>
 
 <span class="n">ShowText</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="s">'Please enter your first name: '</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Readln</span><span class="p">(</span><span class="n">firstname</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="s">'Please enter your surname: '</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Readln</span><span class="p">(</span><span class="n">surname</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">message</span><span class="o">,</span> <span class="s">' '</span><span class="o">,</span> <span class="n">firstname</span><span class="o">,</span> <span class="s">' '</span><span class="o">,</span> <span class="n">surname</span><span class="p">)</span><span class="o">;</span>
