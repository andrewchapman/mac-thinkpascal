...
<title>~the_friar/macintosh-cookbook: examples/time.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Ftime.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/time.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/time.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/time.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/time.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/time.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/time.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<a href="#L19" id="L19">19</a></pre>
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleTime</span><span class="o">;</span>

 <span class="k">var</span>
  <span class="nb">date</span><span class="o">:</span> <span class="n">DateTimeRec</span><span class="o">;</span>
  <span class="n">seconds</span><span class="o">:</span> <span class="kt">Longint</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="n">ShowText</span><span class="o">;</span>
 
 <span class="nb">GetTime</span><span class="p">(</span><span class="nb">date</span><span class="p">)</span><span class="o">;</span>
 <span class="n">GetDateTime</span><span class="p">(</span><span class="n">seconds</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="s">'The current time is:'</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="nb">date</span><span class="o">.</span><span class="n">hour</span> <span class="o">:</span> <span class="mi">2</span><span class="o">,</span> <span class="s">':'</span><span class="o">,</span> <span class="nb">date</span><span class="o">.</span><span class="n">minute</span> <span class="o">:</span> <span class="mi">2</span><span class="o">,</span> <span class="s">':'</span><span class="o">,</span> <span class="nb">date</span><span class="o">.</span><span class="n">second</span> <span class="o">:</span> <span class="mi">2</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="s">'Seconds since midnight, January 1, 1904:'</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="o">-</span><span class="n">seconds</span><span class="p">)</span><span class="o">;</span>
