...
<title>~the_friar/macintosh-cookbook: examples/julia.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Fjulia.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/julia.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/julia.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/julia.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/julia.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/julia.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/julia.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<a href="#L71" id="L71">71</a></pre>
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleJulia</span><span class="o">;</span>

 <span class="k">const</span>
  <span class="n">scale</span> <span class="o">=</span> <span class="mf">0.01</span><span class="o">;</span>
 ...
 <span class="k">var</span>
  <span class="n">i</span><span class="o">,</span> <span class="n">j</span><span class="o">,</span> <span class="n">k</span><span class="o">,</span> <span class="n">n</span><span class="o">,</span> <span class="n">row</span><span class="o">,</span> <span class="n">col</span><span class="o">,</span> <span class="n">Nit</span><span class="o">:</span> <span class="kt">Integer</span><span class="o">;</span>
  ...
  <span class="n">drawingRect</span><span class="o">:</span> <span class="nb">Rect</span><span class="o">;</span>
 ...
 <span class="k">procedure</span> <span class="nf">add</span> <span class="p">(</span><span class="n">a</span><span class="o">,</span> <span class="n">b</span><span class="o">:</span> <span class="n">complex</span><span class="o">;</span> <span class="k">var</span> <span class="n">c</span><span class="o">:</span> <span class="n">complex</span><span class="p">)</span><span class="o">;</span>
 <span class="k">begin</span>
 ...
 <span class="k">procedure</span> <span class="nf">plot</span> <span class="p">(</span><span class="n">c</span><span class="o">,</span> <span class="n">r</span><span class="o">:</span> <span class="kt">integer</span><span class="p">)</span><span class="o">;</span>
 <span class="k">begin</span>
...
<span class="k">begin</span>
 ...
 <span class="nb">Writeln</span><span class="p">(</span><span class="s">'Value of Nit,Cr,Ci?'</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">ReadLn</span><span class="p">(</span><span class="n">Nit</span><span class="o">,</span> <span class="n">c</span><span class="o">.</span><span class="n">r</span><span class="o">,</span> <span class="n">c</span><span class="o">.</span><span class="n">i</span><span class="p">)</span><span class="o">;</span>

 <span class="n">Showdrawing</span><span class="o">;</span>
 <span class="n">SetRect</span><span class="p">(</span><span class="n">drawingRect</span><span class="o">,</span> <span class="mi">200</span><span class="o">,</span> <span class="mi">40</span><span class="o">,</span> <span class="mi">600</span><span class="o">,</span> <span class="mi">400</span><span class="p">)</span><span class="o">;</span>
 ...
 <span class="k">for</span> <span class="n">col</span> <span class="o">:=</span> <span class="mi">1</span> <span class="k">to</span> <span class="mi">400</span> <span class="k">do</span>
  <span class="k">for</span> <span class="n">row</span> <span class="o">:=</span> <span class="mi">1</span> <span class="k">to</span> <span class="mi">400</span> <span class="k">do</span>
   <span class="k">begin</span>
    <span class="n">z</span><span class="o">.</span><span class="n">r</span> <span class="o">:=</span> <span class="p">(</span><span class="n">col</span> <span class="o">-</span> <span class="mi">200</span><span class="p">)</span> <span class="o">*</span> <span class="n">scale</span><span class="o">;</span>
    <span class="n">z</span><span class="o">.</span><span class="n">i</span> <span class="o">:=</span> <span class="p">(</span><span class="n">row</span> <span class="o">-</span> <span class="mi">200</span><span class="p">)</span> <span class="o">*</span> <span class="n">scale</span><span class="o">;</span>
    <span class="k">repeat</span>
     ...
     <span class="n">add</span><span class="p">(</span><span class="n">znew</span><span class="o">,</span> <span class="n">c</span><span class="o">,</span> <span class="n">z</span><span class="p">)</span><span class="o">;</span>
    ...
    <span class="k">if</span> <span class="n">done</span> <span class="k">then</span>
     <span class="n">plot</span><span class="p">(</span><span class="n">col</span><span class="o">,</span> <span class="n">row</span><span class="p">)</span><span class="o">;</span>
    <span class="n">n</span> <span class="o">:=</span> <span class="mi">0</span><span class="o">;</span>
   <span class="k">end</span><span class="o">;</span>

<span class="k">end</span><span class="o">.</span>

<span class="cm">{ note: Interesting fractals }</span>
<span class="cm">{ 10 0   1 }</span>
<span class="cm">{ 50 0.3 -0.5 }</span>
</pre></div>
</div>
</div>
