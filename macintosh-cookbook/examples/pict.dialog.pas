...
<title>~the_friar/macintosh-cookbook: examples/pict.dialog.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Fpict.dialog.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/pict.dialog.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/pict.dialog.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/pict.dialog.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/pict.dialog.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/pict.dialog.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/pict.dialog.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleDrawingExport</span><span class="o">;</span>
 ...
 <span class="k">var</span>
  ...
  <span class="n">outputRefNum</span><span class="o">:</span> <span class="kt">Integer</span><span class="o">;</span>

 <span class="k">procedure</span> <span class="nf">Cleanup</span><span class="o">;</span>
 <span class="k">begin</span>
  <span class="k">if</span> <span class="n">outputRefNum</span> <span class="o">&lt;&gt;</span> <span class="o">-</span><span class="mi">1</span> <span class="k">then</span>
   <span class="k">begin</span>
    <span class="n">err</span> <span class="o">:=</span> <span class="n">FSClose</span><span class="p">(</span><span class="n">outputRefNum</span><span class="p">)</span><span class="o">;</span>
    <span class="n">outputRefNum</span> <span class="o">:=</span> <span class="o">-</span><span class="mi">1</span><span class="o">;</span>
 ...
 <span class="k">procedure</span> <span class="nf">PaintPicture</span><span class="o">;</span>
  <span class="k">var</span>
   <span class="n">clip</span><span class="o">,</span> <span class="n">oval</span><span class="o">:</span> <span class="nb">rect</span><span class="o">;</span>
 <span class="k">begin</span>
  ...
  <span class="n">FillOval</span><span class="p">(</span><span class="n">oval</span><span class="o">,</span> <span class="n">ltgray</span><span class="p">)</span><span class="o">;</span>
 ...
 <span class="k">procedure</span> <span class="nf">WriteFile</span><span class="o">;</span>
  <span class="k">var</span>
 ...
 <span class="k">begin</span>
  ...
  <span class="k">for</span> <span class="n">i</span> <span class="o">:=</span> <span class="mi">1</span> <span class="k">to</span> <span class="mi">512</span> <span class="k">div</span> <span class="nb">SizeOf</span><span class="p">(</span><span class="kt">Longint</span><span class="p">)</span> <span class="k">do</span>
   <span class="n">err</span> <span class="o">:=</span> <span class="n">FSWrite</span><span class="p">(</span><span class="n">outputRefNum</span><span class="o">,</span> <span class="n">toWrite</span><span class="o">,</span> <span class="o">@</span><span class="n">bigZero</span><span class="p">)</span><span class="o">;</span>
  ...
  <span class="n">err</span> <span class="o">:=</span> <span class="n">FSWrite</span><span class="p">(</span><span class="n">outputRefNum</span><span class="o">,</span> <span class="n">toWrite</span><span class="o">,</span> <span class="kt">Pointer</span><span class="p">(</span><span class="n">pic</span><span class="o">^</span><span class="p">))</span><span class="o">;</span>
 ...
 <span class="k">procedure</span> <span class="nf">CreateFile</span><span class="o">;</span>
  <span class="k">var</span>
 ...
 <span class="k">begin</span>
  ...
  <span class="n">SFPutFile</span><span class="p">(</span><span class="n">wher</span><span class="o">,</span> <span class="s">'Save the PICT as:'</span><span class="o">,</span> <span class="s">'untitled.pict'</span><span class="o">,</span> <span class="k">nil</span><span class="o">,</span> <span class="n">reply</span><span class="p">)</span><span class="o">;</span>
  <span class="k">if</span> <span class="n">reply</span><span class="o">.</span><span class="n">good</span> <span class="k">then</span>
   <span class="k">begin</span>
    ...
    <span class="k">if</span> <span class="p">(</span><span class="n">err</span> <span class="o">=</span> <span class="n">noerr</span><span class="p">)</span> <span class="err">|</span> <span class="p">(</span><span class="n">err</span> <span class="o">=</span> <span class="n">dupfnerr</span><span class="p">)</span> <span class="k">then</span>
     <span class="k">begin</span>
      <span class="n">err</span> <span class="o">:=</span> <span class="n">FSOpen</span><span class="p">(</span><span class="n">reply</span><span class="o">.</span><span class="n">fname</span><span class="o">,</span> <span class="n">reply</span><span class="o">.</span><span class="n">vrefnum</span><span class="o">,</span> <span class="n">outputRefNum</span><span class="p">)</span><span class="o">;</span>
      <span class="n">WriteFile</span><span class="o">;</span>
     <span class="k">end</span><span class="o">;</span>
   <span class="k">end</span><span class="o">;</span>
 <span class="k">end</span><span class="o">;</span>
...
<span class="k">begin</span>
 ...
 <span class="n">CreateFile</span><span class="o">;</span>
