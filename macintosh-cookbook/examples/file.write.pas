...
<title>~the_friar/macintosh-cookbook: examples/file.write.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Ffile.write.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/file.write.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.write.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.write.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/file.write.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/file.write.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/file.write.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleFile</span><span class="o">;</span>

 <span class="k">const</span>
  <span class="n">FILENAME</span> <span class="o">=</span> <span class="s">'data.txt'</span><span class="o">;</span>

 <span class="k">var</span>
  <span class="n">outfile</span><span class="o">:</span> <span class="n">Text</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="n">ShowText</span><span class="o">;</span>

 <span class="nb">ReWrite</span><span class="p">(</span><span class="n">outfile</span><span class="o">,</span> <span class="n">FILENAME</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">outfile</span><span class="o">,</span> <span class="s">'hello world'</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Writeln</span><span class="p">(</span><span class="n">outfile</span><span class="o">,</span> <span class="s">'foo bar'</span><span class="p">)</span><span class="o">;</span>

 <span class="nb">Writeln</span><span class="p">(</span><span class="s">'Writing '</span><span class="o">,</span> <span class="n">FILENAME</span><span class="o">,</span> <span class="s">' complete.'</span><span class="p">)</span><span class="o">;</span>
