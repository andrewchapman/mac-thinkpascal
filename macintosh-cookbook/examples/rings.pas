...
<title>~the_friar/macintosh-cookbook: examples/rings.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Frings.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/rings.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/rings.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/rings.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/rings.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/rings.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/rings.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleRings</span><span class="o">;</span>
 ...
 <span class="k">var</span>
  ...
  <span class="n">Diam</span><span class="o">,</span> <span class="n">Increase</span><span class="o">:</span> <span class="kt">Integer</span><span class="o">;</span>
  <span class="n">Box</span><span class="o">:</span> <span class="nb">Rect</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="n">Top</span> <span class="o">:=</span> <span class="mi">0</span><span class="o">;</span>
 <span class="n">Left</span> <span class="o">:=</span> <span class="mi">0</span><span class="o">;</span>
 <span class="n">Diam</span> <span class="o">:=</span> <span class="mi">0</span><span class="o">;</span>
 <span class="nb">Write</span><span class="p">(</span><span class="s">'Type an integer between 1 and 25: '</span><span class="p">)</span><span class="o">;</span>
 <span class="nb">Read</span><span class="p">(</span><span class="n">Increase</span><span class="p">)</span><span class="o">;</span>
 <span class="n">ShowDrawing</span><span class="o">;</span>
 <span class="k">repeat</span>
  <span class="n">Diam</span> <span class="o">:=</span> <span class="n">Diam</span> <span class="o">+</span> <span class="n">Increase</span><span class="o">;</span>
  <span class="n">Bottom</span> <span class="o">:=</span> <span class="n">Diam</span><span class="o">;</span>
  <span class="n">Right</span> <span class="o">:=</span> <span class="n">Diam</span><span class="o">;</span>
  ...
  <span class="n">FrameOval</span><span class="p">(</span><span class="n">box</span><span class="p">)</span><span class="o">;</span>
 <span class="k">until</span> <span class="n">Diam</span> <span class="o">&gt;</span> <span class="mi">400</span>
