...
<title>~the_friar/macintosh-cookbook: examples/strings.pas - sourcehut git</title>
...
<span class="navbar-text">
    ...
    <a href="https://sr.ht/~the_friar">
      ...
      the_friar</a>
    —
    <a href="https://meta.sr.ht/logout?return_to=https://git.sr.ht%2F~the_friar%2Fmacintosh-cookbook%2Ftree%2F6824fd50ee1338ef52ff250367b4a81e0e80f830%2Fitem%2Fexamples%2Fstrings.pas%3F">Log out</a>
</span>
</div>
</nav>
...
<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830">macintosh-cookbook</a>/<a href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples">examples</a>/strings.pas
...
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/strings.pas">View</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/log/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/strings.pas">Log</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blame/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/strings.pas">Blame</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/blob/6824fd50ee1338ef52ff250367b4a81e0e80f830/examples/strings.pas" rel="noopener noreferrer nofollow">View raw</a>
</li>
<li class="nav-item">
<a class="nav-link" href="/~the_friar/macintosh-cookbook/tree/6824fd50ee1338ef52ff250367b4a81e0e80f830/item/examples/strings.pas">Permalink</a>
</li>
</ul>
</div>
</span>
...
<div class="highlight"><pre><span></span><span class="k">program</span> <span class="n">ExampleStrings</span><span class="o">;</span>
 ...
 <span class="k">var</span>
  ...
  <span class="n">ws</span><span class="o">,</span> <span class="n">hs</span><span class="o">,</span> <span class="n">combined</span><span class="o">:</span> <span class="n">str255</span><span class="o">;</span>
  <span class="n">drawingRect</span><span class="o">:</span> <span class="nb">Rect</span><span class="o">;</span>

<span class="k">begin</span>

 <span class="n">width</span> <span class="o">:=</span> <span class="mi">220</span><span class="o">;</span>
 <span class="n">height</span> <span class="o">:=</span> <span class="mi">140</span><span class="o">;</span>

 <span class="n">NumToString</span><span class="p">(</span><span class="n">width</span><span class="o">,</span> <span class="n">ws</span><span class="p">)</span><span class="o">;</span>
 <span class="n">NumToString</span><span class="p">(</span><span class="n">height</span><span class="o">,</span> <span class="n">hs</span><span class="p">)</span><span class="o">;</span>

 <span class="n">SetRect</span><span class="p">(</span><span class="n">drawingRect</span><span class="o">,</span> <span class="mi">60</span><span class="o">,</span> <span class="mi">60</span><span class="o">,</span> <span class="mi">60</span> <span class="o">+</span> <span class="n">width</span><span class="o">,</span> <span class="mi">60</span> <span class="o">+</span> <span class="n">height</span><span class="p">)</span><span class="o">;</span>
 ...
 <span class="n">WriteDraw</span><span class="p">(</span><span class="s">'Window Size'</span><span class="p">)</span><span class="o">;</span>
 <span class="n">MoveTo</span><span class="p">(</span><span class="mi">20</span><span class="o">,</span> <span class="mi">40</span><span class="p">)</span><span class="o">;</span>
 <span class="n">WriteDraw</span><span class="p">(</span><span class="nb">concat</span><span class="p">(</span><span class="n">ws</span><span class="o">,</span> <span class="s">'x'</span><span class="o">,</span> <span class="n">hs</span><span class="p">))</span><span class="o">;</span>
